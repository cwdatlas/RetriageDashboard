...
public class PatientServiceImp implements PatientService {
    ...
    private void validatePatient(Patient patient) {
        ...
        if (patient.getFirstName() == null || patient.getFirstName().trim().isEmpty()) {
            logger.warn("validatePatient - Patient first name is null or empty.");
        ...
        if (patient.getLastName() == null || patient.getLastName().trim().isEmpty()) {
            logger.warn("validatePatient - Patient last name is null or empty.");
        ...
        if (patient.getRetriageNurse() == null) {
            logger.warn("validatePatient - Patient retriage nurse is null.");
        ...
        if (patient.getRetriageNurse() != null && patient.getRetriageNurse().getRole() != Role.Nurse) {
            logger.warn("validatePatient - Retriage nurse does not have the required Nurse role. Role: {}", patient.getRetriageNurse().getRole());
            throw new IllegalArgumentException("Retriage nurse must have the role of Nurse.");
        }
        logger.debug("Exiting validatePatient - Patient validation successful.");
    }
}